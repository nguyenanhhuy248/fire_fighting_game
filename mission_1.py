...
def mission_1(user_id, player_dictionary):
    ...
    while active_1:
        ...
        prompt_2 = input ('Start mission 1 now? Type \'Y\' to enter the mission, or \'quit\' to exit\n')        
        if prompt_2.lower() == 'y':
            ...
            while active_3:
                ...
                if prompt_3.lower() == 'y':
                    ...
                    while active_4:
                        ...
                        if prompt_4.lower() == 'move':
                            ...
                            if Player.check_valid_direction(
                                ...
                                if matrix[player1.state[0], player1.state[1]] in [8,15]:
                                    player_dictionary.update({'Mission 1' : 'Completed'})
                                    print('Congratulation!!! You have accomplished mission 1!')
                                    player_dictionary.update({'position' : f'{current_position(player1)}'})
                                    active_4 = False
                                    active_3 = False
                                    active_1 = False
                                elif not x:
                    ...
                    prompt_9 = input('To mission 1 description?\
