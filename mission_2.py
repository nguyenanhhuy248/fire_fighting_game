...
def mission_2(user_id, player_dictionary):
    ...
    while active_1:
        ...
        prompt_2 = input ('Start mission 2 now? Type \'Y\' to enter the mission, or \'quit\' to exit\n')        
        if prompt_2.lower() == 'y':

            if f"map_{user_id}.txt" in os.listdir('../saved_file'):
                game_world = np.loadtxt(f"../saved_file/map_{user_id}.txt").reshape(17, 19)
                ...
                if prompt_3.lower() == 'y':
                    ...
                    if 'fire position' in list(player_dictionary.keys()):
                        ...
                        if player_dictionary['e_type'] != '':
                            player1.extinguisher = Extinguisher(player_dictionary['e_type'],player_dictionary['e_power'])
                    ...
                    active_4 = True
                    while active_4:
                        prompt_4 = input('Type \'move\' to start your movement,\
                        ...
                        if prompt_4.lower() == 'move':
                            prompt_5 = input('Which direction do you want to move?\
                            ...
                            if Player.check_valid_direction(
                                ...
                                prompt_6 = input('What is the distance you want to move?\
                                    ...
                                    if not x:
                                        ...
                                        if player1.mask != None:
                                            if player1.extinguisher != None:
                                                active_5 = True
                                                while active_5:
                                                    prompt_12 = input('You are at the fire position. Type \'spray\' to use your extinguisher\n')
                                                    if prompt_12.lower() == 'spray':
                                                        spray(player1, fire1)
                                                        if fire1.power == 0:
                                                            player_dictionary['Mission 2'] = 'Completed'
                                                            print('Congratulation! Fire extinguished! You win!!!')
                                                            active_5 = False
                                                            active_4 = False
                                                            active_3 = False
                                                            active_1 = False
                                                            if f"map_{user_id}.txt" in os.listdir('../saved_file'):
                                                                os.remove(f"../saved_file/map_{user_id}.txt")
                                                        else:
                                                            print(f'Remaining fire power: {fire1.power}')
                                                            print('You need to collect another extinguisher and come back!\n')
                                                            active_5 = False
                                                            active_4 = True
                                                    else:
                                                        print('Incorrect command!')
                                            else:
                                                print('You do not have any fire extinguisher! Go collect one!')
                                        else:
                                            print('A lot of smoke here! You need to have an oxygen mask, go collect one!')
                                    
                                    else:
                                        print(f'Move successfully!!!. Current position: {current_position(player1)}')
                                else:
                            ...
                            prompt_7 = input('You can see the position beside you, which way you want to see?\
                                            \nType \'up\', \'down\', \'left\', \'right\'.\n')
                            if prompt_7 in ['up','down','left','right']:
                                look_value = player1.look(prompt_7)
                                if look_value == False:
                                    print('Beside you in this direction is the room wall!')
                                else:
                                    see = f'{column_list[look_value[1]]}{look_value[0]}'
                                    print(f'The position beside you in this direction is: {see}')
                            else:
                                print('Invalid direction!')
                            ...
                            prompt_8 = input('Do you want to save progress and quit the game?\
                            ...
                            if prompt_8.lower() == 'y':
                                ...
                                with open(f"../saved_file/map_{user_id}.txt", "w") as map:
                    ...
                    prompt_9 = input('To mission 2 description?\
                    ...
                    prompt_10 = input('Do you want to quit the game?\
                                    \nType \'Y\' to quit, or \'N\' go back\n')
            ...
            prompt_11 = input('Do you want to quit the game?\
                            \nType \'Y\' to quit, or \'N\' go back\n')
...
if __name__ == "__main__":
    test_dict ={'Mission 1': 'Completed', 'Mission 2': 'Not completed', 'position': 'A3', 
                'mask': '', 'e_type': '', 'e_power': ''}
